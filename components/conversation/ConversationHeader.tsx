...
export default function ConversationHeader({ config }: ConversationHeaderProps) {
  return (
    <div className="sticky top-20 z-20 w-full px-6 py-4 rounded-t-[24px] bg-[#FAFAFA]/90 backdrop-blur-md border-b border-black/5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 select-none">
